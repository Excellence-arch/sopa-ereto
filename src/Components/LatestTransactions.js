...
const LatestTransactions = ({data}) => {
  return (
    <div className='mx-auto col-12 col-lg-6'>
        <div>
            <p> <span>Latest Transactions</span><span className='float-end btn colors text-white'>View onchain</span></p>
            <div>
              ...
              <tr>
                <td colSpan={5} className='fw-bold text-center p-3'>See more <span className='btn colors'><MaterialIcon icon="arrow_forward" /></span></td>
              </tr>
              </table>
            </div>
        </div>
