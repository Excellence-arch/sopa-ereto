      ...
      <div className='row'>
        <div className='col-12 col-lg-7  mx-auto mt-5'>
            <form className='container'>
                ...
                <input type="text" className="form-control w-100 my-3" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Email" />
                ...
                <button className='btn btn-secondary w-100' onClick={(e) => login(e)}>{isloading ? <span className='spinner-border'></span> : "Login"}</button>
            </form>
        </div>
      </div>
    </div>
